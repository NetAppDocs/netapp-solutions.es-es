...
link:xcp-bp-migration-workflow-overview.html["Anterior: Flujo de trabajo de migración."]
...
image:xcp-bp_image6.png["Error: Falta la imagen gráfica"]


NOTE: Para obtener más información acerca de la arquitectura de alto nivel del análisis de archivos XCP, las vistas de panel basadas en GUI, como la vista de estadísticas y los detalles de la vista de distribución de archivos, consulte la publicación del blog https://["NetApp XCP 1.6 ofrece análisis de archivos abiertos y mejoras en la infraestructura"^].
...
image:xcp-bp_image7.png["Error: Falta la imagen gráfica"]

link:xcp-bp-deployment-steps.html["Siguiente: Pasos de la implementación."]
