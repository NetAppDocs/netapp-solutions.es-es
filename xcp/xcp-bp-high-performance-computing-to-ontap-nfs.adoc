...
Si quiere más información sobre la informática de alto rendimiento para el caso de uso de NFS de ONTAP, una demostración registrada y los resultados de pruebas, consulte https://["Uso de XCP para mover datos desde un lago de datos y la informática de alto rendimiento a NFS de ONTAP"^] blog.

Si quiere ver pasos detallados sobre el movimiento de datos de MapR-FS a NFS de ONTAP mediante XCP de NetApp, consulte el apéndice A: GPFS a NFS―pasos detallados en https://["TR-4732: Análisis de Big Data en la inteligencia artificial"^].
