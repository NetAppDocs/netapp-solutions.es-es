...
link:bda-ai-data-mover-solution.html["Anterior: Solución de movimiento de datos."]
...
El cliente de caso de uso híbrido puede usar Cloud Sync para migrar datos en las instalaciones desde datos NFS, CIFS y S3 al cloud y viceversa para procesar la IA utilizando GPU como las de un clúster de NVIDIA. Se utilizan tanto Cloud Sync como la herramienta de migración XCP para la migración de datos NFS a ONTAP NFS de NetApp.

link:bda-ai-gpfs-to-netapp-ontap-nfs.html["Siguiente: GPFS a ONTAP NFS de NetApp."]
