...
link:cdm-fod-solution-technology.html["Anterior: Tecnología de soluciones."]
...
. Crear un nuevo entorno de trabajo, seleccionar el proveedor de cloud y seleccionar el tipo de instancia de Cloud Volumes ONTAP (como CVO único, alta disponibilidad o Amazon FSxN para ONTAP).
...
link:cdm-fod-conclusion.html["Siguiente: Conclusión."]
