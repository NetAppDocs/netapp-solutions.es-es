...
En el centro de la plataforma Confluente lo es https://["Kafka"^], la plataforma de transmisión distribuida de código abierto más popular. Entre las capacidades clave de Kafka se incluyen las siguientes:
