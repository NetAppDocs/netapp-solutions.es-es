...
Siga los pasos proporcionados en esto link:https://mysupport.netapp.com/site/tools/tool-eula/netapp-shift-toolkit["enlace"] para aprovisionar una nueva SVM que permita el protocolo NFS y SMB.
