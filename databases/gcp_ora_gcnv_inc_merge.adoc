...
El siguiente kit de herramientas de automatización contiene un manual que se puede utilizar para crear o actualizar clones de un Oracle VLDB a partir de una copia de imagen de respaldo de la base de datos principal almacenada en el almacenamiento GCNV a través del montaje NFS para una gestión completa del ciclo de vida de los clones.
