...
[%collapsible]
====
NetApp recomienda la herramienta de interfaz de usuario de SnapCenter para gestionar la base de datos de Oracle implementada en la nube de Azure. Consulte TR-4988: link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["Oracle Database Backup, Recovery y Clone en ANF con SnapCenter"^] para obtener más detalles.
...
+
link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["Oracle Database Backup, Recovery y Clone en ANF con SnapCenter"^]
