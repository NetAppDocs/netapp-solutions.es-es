...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=e479b91f-eacd-46bf-bfa1-b01200f0015a["Implementación y protección automatizadas de bases de datos PostreSQL en AWS EC2/FSx"]
