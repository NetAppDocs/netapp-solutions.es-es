...
Las pruebas y la validación de esta solución se realizaron en un entorno AWS FSx ONTAP y EC2 que podría no coincidir con el entorno de puesta en marcha final. Para obtener más información, consulte la sección <<Key Factors for Deployment Consideration>>.
...
Documentación: link:https://docs.netapp.com/us-en/netapp-solutions/databases/marketing_overview.html#awxtower-deployments["Puesta en marcha automatizada de Oracle19c para ONTAP en NFS"^]
