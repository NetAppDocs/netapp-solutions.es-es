...
Siga estas instrucciones para configurar el nodo de control de Ansible para máquinas RedHat o CentOS: link:../automation/automation_rhel_centos_setup.html["Configuración de la controladora Red Hat/CentOS Ansible"^].
Siga estas instrucciones para configurar el nodo de control de Ansible para máquinas Ubuntu o Debian: link:../automation/automation_ubuntu_debian_setup.html["Configuración de la controladora Ubuntu/Debian Ansible"^].
