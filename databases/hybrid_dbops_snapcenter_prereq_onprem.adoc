...
link:hybrid_dbops_snapcenter_prerequisite.html["Anterior: Requisitos previos de la configuración."]
...
link:hybrid_dbops_snapcenter_prereq_cloud.html["Siguiente: Cloud público."]
