...
[%collapsible%open]
====
Las siguientes herramientas de automatización están específicamente diseñadas para crear o actualizar clones de una base de datos en espera de Oracle Data Guard implementada en ANF con una configuración NFS/ASM para una gestión completa del ciclo de vida de los clones.
