...
....
. Configurar archivo de destino de despliegue - hosts, archivo de variables globales - vars/vars.yml y archivo de variables de VM de base de datos local - host_vars/host_name.yml de acuerdo con las instrucciones de esta sección de TR-4992 link:https://docs.netapp.com/us-en/netapp-solutions/databases/automation_ora_c-series_nfs.html#parameter-files-configuration["Configuración de archivos de parámetros"^]: . Comentar la variable nfs_lif del archivo de variables de VM de base de datos local.
