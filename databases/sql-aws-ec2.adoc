...
+
* Configure cinco sesiones iSCSI por interfaz de destino para un rendimiento óptimo.
* Configure una política round-robin para el mejor rendimiento general de iSCSI.
