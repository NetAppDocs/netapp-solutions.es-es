...
+
image::aws_rds_custom_deploy_fsx_01.PNG[aws rds custom deploy fsx 01]
...
+
image::aws_rds_custom_deploy_snp_01.PNG[implementación personalizada de aws rds snp 01]
...
+
image::aws_rds_custom_deploy_snp_02.PNG[implementación personalizada de aws rds snp 02]
...
+
image::aws_rds_custom_deploy_snp_03.PNG[implementación personalizada de aws rds snp 03]
...
+
image::aws_rds_custom_deploy_snp_04.PNG[implementación personalizada de aws rds snp 04]

+
Compruebe Oracle Database y, antes de enviar, haga clic en más opciones.

+
image::aws_rds_custom_deploy_snp_05.PNG[implementación personalizada de aws rds snp 05]
...
+
image::aws_rds_custom_deploy_snp_06.PNG[implementación personalizada de aws rds snp 06]

+
Se le pedirá que confirme la huella digital y, a continuación, haga clic en Confirm and Submit.

+
image::aws_rds_custom_deploy_snp_07.PNG[implementación personalizada de aws rds snp 07]

+
Después de configurar correctamente el plugin, el estado general del host gestionado se muestra como en ejecución.

+
image::aws_rds_custom_deploy_snp_08.PNG[implementación personalizada de aws rds snp 08]
...
image::aws_rds_custom_deploy_snp_09.PNG[implementación personalizada de aws rds snp 09]
