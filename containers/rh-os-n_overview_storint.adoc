...
Astra Trident de NetApp es un orquestador de almacenamiento de código abierto y totalmente compatible para contenedores y distribuciones de Kubernetes, incluido Red Hat OpenShift. Si quiere más información, visite el sitio web de Astra Trident https://["aquí"].
...
link:rh-os-n_overview_astra.html["Siguiente: Descripción general de Astra Control Center de NetApp"]
