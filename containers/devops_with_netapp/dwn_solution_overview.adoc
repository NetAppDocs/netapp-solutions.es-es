...
* https://["Guardabosques"] 2.5 o posterior
* https://["Kubernetes"] 1.20 o posterior
* https://["Grid de Kubernetes de VMware Tanzania"] 1.4 o posterior
* https://["VMware Tanzu Kubernetes Grid Integrated Edition"] 1.12.2 o posterior
