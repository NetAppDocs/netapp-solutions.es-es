...
image:redhat_openshift_image64.jpg["Error: Falta la imagen gráfica"]

Para obtener más información sobre los sistemas de almacenamiento NetApp Element, visite https://["Sitio web de SolidFire de NetApp"^].
