...
image::rh-os-n_use_case_vm_migration_using_mtv.png[rh os n caso de uso migración de vm usando mtv]
...
image::rh-os-n_use_case_vm_migration_source_provider.png[rh os n use case proveedor de origen de migración de vm]
...
image::rh-os-n_use_case_vm_migration_using_mtv_plan_ready.png[rh os n use case migración de vm utilizando mtv plan ready]

Al hacer clic en *Start* se ejecutará una secuencia de pasos para completar la migración de la VM.

image::rh-os-n_use_case_vm_migration_using_mtv_plan_complete.png[rh os n use case migración de vm mediante plan de mtv completado]
