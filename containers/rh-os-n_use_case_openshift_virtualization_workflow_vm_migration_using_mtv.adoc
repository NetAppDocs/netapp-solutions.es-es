...
[role="lead"]
En esta sección se explica cómo migrar una máquina virtual entre clústeres que utilizan el kit de herramientas de migración de Red Hat OpenShift Virtualization.
