...
NetApp cuenta con varios sistemas de almacenamiento perfectos para centros de datos empresariales y para puestas en marcha de cloud híbrido. La cartera de NetApp incluye sistemas de almacenamiento NetApp ONTAP, Cloud Volumes ONTAP, Cloud Volumes Service, Azure NetApp Files y FSx ONTAP para NetApp ONTAP, que todos pueden proporcionar almacenamiento persistente para aplicaciones en contenedores.
