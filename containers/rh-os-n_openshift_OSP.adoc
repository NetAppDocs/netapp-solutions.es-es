...
Para obtener más información sobre OSP, consulte https://["Sitio web de Red Hat OpenStack Platform"^].
...
Para configurar grupos de afinidad, consulte https://["¿Cómo puedo configurar Affinity y Anti-Affinity para las instancias de OpenStack?"^].
