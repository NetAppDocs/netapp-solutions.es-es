...
image::a-w-n_anthos_controlplanev2_vm_architecture.png[a w n antos arquitectura de máquinas virtuales de controlplanev2]
...
image::a-w-n_anthos-128-vsphere8_validation.png[a w n la validación 128 vsphere8 de anthos]
