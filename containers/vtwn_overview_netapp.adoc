...
summary: NetApp tiene varias plataformas de almacenamiento que están cualificadas con Trident y Trident protegen con el fin de aprovisionar, proteger y gestionar datos para aplicaciones en contenedores, y de este modo ayudar a definir y maximizar el rendimiento de DevOps. 
---
...
[role="lead"]
NetApp tiene varias plataformas de almacenamiento que están cualificadas con Trident y Trident protegen con el fin de aprovisionar, proteger y gestionar datos para aplicaciones en contenedores, y de este modo ayudar a definir y maximizar el rendimiento de DevOps.
