...
. Para utilizar los libros de estrategia de Ansible para poner en marcha Astra Control Center, debe tener una máquina Ubuntu/RHEL con Ansible instalada. Siga el procedimiento descrito https://["aquí"] Para Ubuntu y. https://["aquí"] Para RHEL.
