...
* Combine la potencia de las cargas de trabajo virtualizadas y de contenedores empresariales con Anthos puesto en vSphere o de forma básica con https://["reconocimiento de la virtualización"^].
...
Para obtener más información sobre Anthos, consulte el sitio web de Anthos que se encuentra https://["aquí"^].
...
Consulte https://["aquí"] para conocer la matriz de soporte de versiones validadas.
