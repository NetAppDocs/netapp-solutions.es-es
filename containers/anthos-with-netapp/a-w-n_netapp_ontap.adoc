...
image:a-w-n_ontap_onpremises_virt_cloud.png["Error: Falta la imagen gráfica"]
...
Para obtener más información sobre las plataformas FAS y AFF de NETAPP, haga clic en https://["aquí"].
