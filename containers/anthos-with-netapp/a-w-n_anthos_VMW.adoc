...
image:a-w-n_anthos_vm_architecture.png["Error: Falta la imagen gráfica"]
...
La siguiente tabla contiene plataformas de servidores que han sido probadas por ingenieros de partners de NetApp y NetApp para validar los clústeres de Anthos en puestas en marcha de VMware. Entre ellos se incluyen soluciones como el https://www.netapp.com/data-storage/flexpod/documentation/["FlexPod de NetApp"^] Con los servidores Cisco UCS y el https://docs.netapp.com/us-en/hci/["NetApp HCI"^] plataforma de infraestructura de cloud híbrido.
...
| VSphere de VMware | 6.7U3 | 1.11 


| VSphere de VMware | 7.0U3 | 1.11 
|===
...
|===
Durante la validación de la plataforma Anthos Ready realizada por NetApp, el entorno de laboratorio se creó en función del siguiente diagrama, lo que nos permitió probar varios clústeres de usuarios puestos en marcha junto con varios sistemas de almacenamiento de NetApp y back-ends de almacenamiento.

image:a-w-n_anthos_vmware_validation.png["Error: Falta la imagen gráfica"]
