...
Para obtener más información acerca de RHV, consulte https://["Sitio web de Red Hat Virtualization"^].
...
Para configurar grupos de afinidad, consulte https://["Red Hat 6.11. Documentación de grupos de afinidad"^].
