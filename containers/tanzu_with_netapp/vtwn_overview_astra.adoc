...
. Para utilizar los libros de estrategia de Ansible que ponen en marcha Astra Control Center, debe tener una máquina Ubuntu/RHEL con Ansible instalada. Siga los procedimientos https://["aquí"] Para Ubuntu y RHEL.
