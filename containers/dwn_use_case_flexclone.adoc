...
. Un sistema NetApp ONTAP con un back-end de almacenamiento configurado mediante NetApp Trident.
...
Cada uno de estos entornos lo gestiona Astra Control de NetApp, con volúmenes persistentes actualmente almacenados en un sistema de almacenamiento de NetApp ONTAP con un back-end NFS que proporciona NetApp Trident.
