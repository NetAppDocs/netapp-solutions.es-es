...
Para obtener más información sobre VMware vSphere, consulte https://["Sitio web de VMware vSphere"^].
...
Para configurar grupos de afinidad, consulte https://["Documentación de vSphere 6.7: Uso de las reglas de afinidad de DRS"^].
