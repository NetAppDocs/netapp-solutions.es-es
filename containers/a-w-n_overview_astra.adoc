...
Para conocer la instalación y configuración de Trident para ser compatible con Astra Control Center, consulte link:rh-os-n_overview_trident.html["este documento"^].
