...
Imagen::redhat_openshift_OADP_backup_image1.jpg[Backup completado]
...
Imagen::redhat_openshift_OADP_backup_image3.jpg[Schedule Creado]

Las copias de seguridad se crearán de acuerdo con esta programación y se podrán ver desde la pestaña Copia de seguridad.
Imagen::redhat_openshift_OADP_backup_image4.jpg[Schedule Creado]
