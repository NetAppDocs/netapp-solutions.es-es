...
+
image:redhat_openshift_image82.png["Página principal de observabilidad"]
...
+
image:redhat_openshift_image83.png["Observe los pods"]
...
+
image:redhat_openshift_image84.png["Observe los nodos"]
...
+
image:redhat_openshift_image85.png["Observe los clústeres"]
