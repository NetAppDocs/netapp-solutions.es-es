...
. Instale la extensión F5 Application Services 3 para permitir que los sistemas BIG-IP acepten configuraciones en JSON en lugar de comandos de imperativo. Vaya a. https://["Repositorio de F5 AS3 GitHub"^]Y descargue el último archivo RPM.
