...
---
= Implementación de Microsoft Hyper-V en almacenamiento de NetApp: Script de migración
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta sección contiene un script de PowerShell que se puede utilizar para migrar usando FlexClone.
