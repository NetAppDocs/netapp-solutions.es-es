...
[cols="10%, 30%, 60%"]
|===
| *Fecha* | * Área de solución* | *Descripción del cambio* / tag::ent-db[] 
...
| 05 PB/14/2024 | Virtualización | Se ha agregado una migración de equipos virtuales a Amazon EC2 mediante el contenido FSxN 
