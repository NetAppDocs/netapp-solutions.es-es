...
. Ya tiene un clúster de Kubernetes en funcionamiento y ejecuta una versión de Kubernetes que admite ubeflow. Para obtener una lista de las versiones compatibles, consulte https://["Documentación oficial de Kubeflow"^].
...
NOTE: Como alternativa, puede implementar Kubeflow manualmente siguiendo la https://["instrucciones de instalación"^] En la documentación oficial de Kubeflow

. Implemente Kubeflow en su clúster siguiendo el https://["Instrucciones de despliegue de Kubeflow"^] En el sitio de NVIDIA DeepOps GitHub.
...
+
El nombre de usuario predeterminado es `admin@kubeflow.org`, y la contraseña predeterminada es `12341234`. Para crear usuarios adicionales, siga las instrucciones de https://["Documentación oficial de Kubeflow"^].
