...
summary: values-xml - solución de base de datos vectorial para NetApp 
---
...
[role="lead"]
En esta sección se proporciona un código YAML de ejemplo para los valores utilizados en la solución de base de datos vectorial NetApp.
