...
summary: 'Pod de IA de NetApp con sistemas NVIDIA DGX: Componentes de software' 
---
= Pod de IA de NetApp con sistemas NVIDIA DGX: Componentes de software
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:aipod_nv_hw_components.html["Anterior: AI de ONTAP: Componentes de hardware."]
...
image:oai_BaseCommand.png["Error: Falta la imagen gráfica"]
...
image:oai_ngc.png["Error: Falta la imagen gráfica"]
...
* Rendimiento y menor latencia. ONTAP ofrece la salida más alta posible con la menor latencia posible, incluida la compatibilidad con el almacenamiento GPUDirect (GDS) de NVIDIA usando NFS a través de RDMA.
...
link:aipod_nv_architecture.html["Siguiente: NetApp AI Pod con sistemas NVIDIA DGX: Arquitectura."]
