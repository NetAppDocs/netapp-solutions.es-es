...
image:NVIDIAlogo.png["200.200, Error: Falta la imagen gráfica"]
...
image:EF_SuperPOD_HighLevel.png["Error: Falta la imagen gráfica"]
...
image:EF_SuperPOD_buildingblock.png["Error: Falta la imagen gráfica"]
