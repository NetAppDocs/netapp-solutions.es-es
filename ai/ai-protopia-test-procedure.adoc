...
....
. Almacene su modelo en el nuevo volumen persistente en un https://github.com/triton-inference-server/server/blob/main/docs/model_repository.md["formato"^] Reconocida por el servidor de inferencia NVIDIA Triton.
+
