...
_Topología de la solución AIpod de NetApp_ image:aipod_nv_a900topo.png[""]
...
_Configuración lógica del clúster de almacenamiento de NetApp A900_ image:aipod_nv_A900logical.png[""]
