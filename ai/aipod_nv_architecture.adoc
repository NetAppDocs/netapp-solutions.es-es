...
_NetApp solución AIpod topology_ image::aipod_nv_a900topo.png[]
...
_NetApp A900 cluster de almacenamiento configuración lógica_ image::aipod_nv_A900logical.png[]
