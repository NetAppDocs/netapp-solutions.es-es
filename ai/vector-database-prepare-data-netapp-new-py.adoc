...
summary: Prepare Data para la solución de bases de datos de vectores para NetApp 
---
...
[role="lead"]
Esta sección proporciona un script Python de ejemplo utilizado para preparar datos para la base de datos vectorial.
