...
| link:containers/devops_with_netapp/dwn_solution_overview.html["DevOps con NetApp Astra"] | link:containers/rh-os-n_videos_astra_control_flexclone.html["Vídeo: Acelere el desarrollo de software con Astra Control y la tecnología FlexClone de NetApp"] 
