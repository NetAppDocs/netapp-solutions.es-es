...
| *Deduplicación* | Sí, No, Cualquiera | Todo | Obligatorio para AFF en 7,2 y posteriores. 


| *Cifrado* | Sí, No, Cualquiera | 7,2 y posterior | Selecciona o crea un volumen de FlexVol cifrado. Se requiere una licencia de ONTAP. 
...
| *Personalidad* | AFF, FAS | 7,2 y posterior | FAS también incluye otros sistemas que no son AFF, como ONTAP Select. AFF incluye a ASA. 
...
| *Política de organización en niveles* | Cualquiera, Ninguna, Instantánea, Automático | 7,2 y posterior | Se usa para FabricPool; se requiere AFF o ASA con ONTAP 9,4 o posterior. Solo se recomienda Snapshot a menos que se utilice una solución S3 en sus instalaciones como StorageGRID de NetApp. 
|===
