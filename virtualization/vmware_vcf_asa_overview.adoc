...
* *Utilice las herramientas de ONTAP para implementar almacenes de datos iSCSI en un dominio de administración de VCF*. Haga clic en https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_mgmt_iscsi.html["*aquí*"] para pasos de despliegue.
* *Utilice las herramientas de ONTAP para implementar almacenes de datos vVols (iSCSI) en un dominio de carga de trabajo VI*. Haga clic en https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_vvols.html["*aquí*"] para pasos de despliegue.
* *Configurar almacenes de datos NVMe sobre TCP para su uso en un dominio de carga de trabajo VI*. Haga clic en https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_nvme.html["*aquí*"] para pasos de despliegue.
* * Implementar y utilizar el complemento de SnapCenter para VMware vSphere para proteger y restaurar máquinas virtuales en un dominio de carga de trabajo VI*. Haga clic en https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_scv_wkld.html["*aquí*"] para pasos de despliegue.
