...
* *Servicios en la nube* Utilice el servicio de copia de seguridad y recuperación de BlueXP o SnapMirror Cloud para proteger los datos de los sistemas locales mediante el almacenamiento en la nube pública. La copia y sincronización de BlueXP ayudan a migrar y mantener tus datos sincronizados en NAS, almacenes de objetos y almacenamiento de Cloud Volumes Service.
