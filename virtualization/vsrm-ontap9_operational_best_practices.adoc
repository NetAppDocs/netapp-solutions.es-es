...
....
el ajuste de tamaño automático de volumen debe estar establecido en `grow` Para volúmenes que contienen almacenes de datos SAN y `grow_shrink` Para almacenes de datos NFS. Consulte la https://["Centro de documentación de ONTAP 9"^] para una sintaxis específica.
