...
Para obtener la información más reciente sobre SnapMirror y SnapVault para ONTAP 9, consulte https://["TR-4015 Guía de mejores prácticas para la configuración de SnapMirror para ONTAP 9."^]
