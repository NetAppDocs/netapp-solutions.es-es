...
+
Si utiliza ONTAP 9.6 o una versión anterior, debe utilizar la herramienta RBAC User Creator (RUC) disponible en https://["Toolchest del sitio de soporte de NetApp"^].
