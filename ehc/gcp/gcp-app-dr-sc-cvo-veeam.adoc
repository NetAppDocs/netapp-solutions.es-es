...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=395e33db-0d63-4e48-8898-b01200f006ca["VÍDEO: Protección de SQL VM con SnapCenter"]
...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8b7e4a9b-7de1-4d48-a8e2-b01200f00692["VÍDEO: Replicación de Veeam de SQL VM"]

====
.Conmutación al nodo de respaldo de Microsoft SQL Server VM
[%collapsible]
====
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9762dc99-081b-41a2-ac68-b01200f00ac0["VÍDEO: Recuperación tras fallos de SQL VM"]
