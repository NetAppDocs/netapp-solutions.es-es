...
. En la página *Destination*, seleccione el destino como cluster/hosts de SDDC de GCVE y el conjunto de recursos adecuado, la carpeta de VM y el almacén de datos de GCNV para las réplicas de VM. Haga clic en *Siguiente* para continuar.
+
