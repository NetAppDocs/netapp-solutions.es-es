...
Para obtener instrucciones paso a paso de ejemplo sobre la configuración de SnapCenter y la replicación de datos, consulte https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-guest-dr-overview.html#config-snapmirror["Configurar la replicación con SnapCenter"]
