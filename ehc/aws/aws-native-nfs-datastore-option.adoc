...
Para obtener más información sobre el rendimiento de Amazon FSX para ONTAP, consulte https://["Rendimiento de Amazon FSX para ONTAP de NetApp"^].
...
[%collapsible]
====
. Conecte el VPC designado recientemente creado al grupo de SDDC. Seleccione la ficha *VPC externo* y siga la https://["Instrucciones para asociar un VPC externo al grupo"^]. El proceso puede tardar 10-15 minutos en completarse.
+
