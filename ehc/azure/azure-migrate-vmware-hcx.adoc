...
Para obtener más información sobre este proceso, siéntase libre de hacerlo link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=255640f5-4dff-438c-8d50-b01200f017d1["siga el vídeo tutorial detallado"].

Esta es una captura de pantalla de la opción HCX vMotion.

image:anfd-hcx-image20.png["Error: Falta la imagen gráfica"]

Para obtener más información sobre este proceso, siéntase libre de hacerlo link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=986bb505-6f3d-4a5a-b016-b01200f03f18["siga el vídeo tutorial detallado"].
