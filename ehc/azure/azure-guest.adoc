...
. Seleccione los servicios complementarios para la puesta en marcha de Cloud Volumes ONTAP, incluidos Cloud Data Sense, Cloud Backup y Cloud Insights. Seleccione los servicios y haga clic en Continue.
+
