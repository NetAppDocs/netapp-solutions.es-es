...
[%collapsible]
====
El primer paso es configurar Cloud Volumes ONTAP en Azure (https://docs.netapp.com/us-en/netapp-solutions/ehc/azure/azure-guest.html["Enlace"^]) Y replicar los volúmenes deseados en Cloud Volumes ONTAP con las frecuencias y retentions de instantánea deseadas.
