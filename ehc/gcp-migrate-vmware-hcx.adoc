...
* Utilice un centro de datos definido por software (SDDC) de Google Cloud VMware Engine o cree un cloud privado utilizando este método https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp-setup.html["Enlace a NetApp"^] o esto https://cloud.google.com/vmware-engine/docs/create-private-cloud["Vínculo de Google"^].
