...
*Airgap (Lógico)* - Puede configurar el almacenamiento de NetApp con ONTAP como una bóveda cibernética lógica de aire comprimido mediante el aprovechamiento link:https://docs.netapp.com/us-en/ontap/snaplock/commit-snapshot-copies-worm-concept.html["SnapLock Compliance para proteger WORM las copias Snapshot"^]
