...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["Hosts VMware vSphere puestos en marcha con estructura de almacenamiento doble (dos HBA o VLAN doble para iSCSI) por host"].
...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["Las máquinas virtuales de almacenamiento y las LIF están disponibles"]
